    ...
    <header className="h-16 px-4 bg-slate-900/90 border-b border-slate-800 backdrop-blur-md flex items-center justify-between z-30 shrink-0 select-none">
      ...
      <div className="flex items-center gap-2">
        ...
        <div className="relative group">
          ...
          <div className="absolute top-full right-0 mt-1 w-64 rounded-xl bg-slate-900 border border-slate-700 shadow-2xl p-1.5 z-50 hidden group-hover:block hover:block animate-in fade-in slide-in-from-top-1 duration-150">
            ...
            >
              <FileText className="w-4 h-4 text-indigo-400 group-hover:text-white shrink-0" />
              <div>
                <div className="font-bold text-white">Download Markdown (.md)</div>
                <div className="text-[10px] opacity-75">Raw markdown specification</div>
              </div>
            </button>
            <button
              onClick={() => printWorkflowSddPdf(activeWorkflow)}
              className="w-full text-left px-2.5 py-2 rounded-lg text-xs flex items-center gap-2 text-slate-200 hover:bg-slate-800 transition-colors border-t border-slate-800/80 mt-1"
            >
              <Printer className="w-4 h-4 text-slate-400 shrink-0" />
              <div>
                <div className="font-medium text-slate-300">Open Print View</div>
                <div className="text-[10px] text-slate-500">Browser print window</div>
              </div>
            </button>
          </div>
        </div>
